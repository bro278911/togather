...
<body>
  ...
  <li> <a>會員專區</a>
	...
	<article>
	<form action="Order_food_finish.php" method="post" onsubmit="return check_select()">
    ...
    <input type="hidden" name="Order_ID" value="<?php echo "$Oname"; ?>">
     ...
     <div >
	        ...
	        <tbody>
	          ...
	          <tr>
	           <th><label><font color="red">*</font> 規格 <dfn>Size</dfn>(若無規格則自動忽略)</label></th>
	           <td height="40px">
	...
	<p><button id="btncheck" style="width:150px;height:60px;border:2px #9999FF;background-color:#CCCCFF;font-size: 22px;font-family: 微軟正黑體"><b>新增餐點</b></button>
	</p>
	</div>
  </form>
